...
export type FakeAuthMiddleware = (req: {
    user?: FakeUser;
}, _res: unknown, next: () => void) => void;
export declare function fakeAuth(user: FakeUser): FakeAuthMiddleware;
/**
 ...
 */
export declare function fakeAuthModule(user: FakeUser): {
